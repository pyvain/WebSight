...
<head><?php $this->load->helper('url'); ?>
	...
	<title>WebSight | Moderators' office</title>

</head>
<body>
	<div class="container">

		<h1>Moderators' office</h1>
		<p>
			Here are all the advice recently added by collaborators.
		</p>
		<p>
			When hitting the <button class="btn btn-success" type="submit">Validate</button> button, it will take your edits in consideration.<br>
		</p>
		<p>
			Ready ... <br>Steady ... <br>Moderate!
		</p>
		<?=validation_errors()?>
