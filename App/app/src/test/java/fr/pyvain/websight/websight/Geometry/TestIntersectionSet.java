...
public class TestIntersectionSet {
	...
	public void testAdd() {
		...
		Intersection i1 = new Intersection(new CPoint(0, 0), s1, s2);
		intersections.add(i1);
		ArrayList<Intersection> interAt0;
		interAt0 = new ArrayList<>(intersections.at(0));
		assertEquals(1, interAt0.size());
		assertEquals(new CPoint(0, 0), interAt0.get(0).getLocation());
		...
		Segment s3 = new Segment(new CPoint(-50, -200), new CPoint(50,200));
		Intersection i2 = new Intersection(new CPoint(0, 0), s1, s3);
		...
		// New location
		Segment s4 = new Segment(new CPoint(-200, 0), new CPoint(0, -200));
		Intersection i3 = new Intersection(new CPoint(-100, -100), s3, s4);
		intersections.add(i3);
		ArrayList<Intersection> interAtX;
		interAtX = new ArrayList<>(intersections.at(-100));
		assertEquals(1, interAtX.size());
		assertEquals(new CPoint(-100, -100), interAtX.get(0).getLocation());
	...
	public void testSize() {
		...
		Segment s3 = new Segment(new CPoint(-200, -200), new CPoint(200,200));
		Intersection i2 = new Intersection(new CPoint(0, 0), s1, s3);
		intersections.add(i2);
		assertEquals(1, intersections.size());
	...
	public void testToArray() {
		...
		intersections.add(i2);
		assertEquals(1, intersections.toArray().length);
		Intersection i12 = new Intersection(new CPoint(0, 0), s1, s2);
